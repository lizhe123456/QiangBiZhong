...
public class ToastUtil {
    ...
    public static void showShortToast(String msg) {
        showCustomToast(App.getContext(), msg, Toast.LENGTH_SHORT);
    }

    public static void showShortToast(int msgId) {
        showCustomToast(App.getContext(), msgId, Toast.LENGTH_SHORT);
    }

    public static void showLongToast(String msg) {
        showCustomToast(App.getContext(), msg, Toast.LENGTH_LONG);
    }

    public static void showLongToast(int msgId) {
        showCustomToast(App.getContext(), msgId, Toast.LENGTH_LONG);
    }
