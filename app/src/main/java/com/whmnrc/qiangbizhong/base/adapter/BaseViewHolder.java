package com.whmnrc.qiangbizhong.base.adapter;
...
public class BaseViewHolder extends RecyclerView.ViewHolder{
    ...
    public BaseViewHolder setGlieuNoCacheImage(int viewId,String url){
        ImageView view = getView(viewId);
        GlideuUtil.loadImageViewNoCache(mContext, url, view);
        return this;
    }

    public BaseViewHolder setCircleGlieuImage(int viewId,String url){
        ImageView view = getView(viewId);
        GlideuUtil.loadCircle(mContext, url, view);
        return this;
    }

    public BaseViewHolder setCropCircleGlieuImage(int viewId,String url){
        ImageView view = getView(viewId);
        GlideuUtil.loadCropCircle(mContext, url, view);
        return this;
    }
