...
public class ShopsListAdapter extends BaseAdapter<StroeBean.ResultBean.GoodsBean> {
    ...
    @Override
    protected void bindDataToItemView(BaseViewHolder holder, StroeBean.ResultBean.GoodsBean item, int position) {
    ...
    @Override
    protected int getItemViewLayoutId(int position, StroeBean.ResultBean.GoodsBean item) {
