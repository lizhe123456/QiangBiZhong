...
public class AwardDetailActivity extends BaseActivity {
    ...
    protected void setData() {
        ...
        showLoading("加载中..");
        goodsRushInfoPresenter.awardInfo(goodsId,this::awardBack);
    }

    private void awardBack(AwardBeanInfo awardBeanInfo) {
    ...
    private void updateData(AwardBeanInfo awardBeanInfo) {
        ...
        tvOldMoeny.setText(String.valueOf(awardBeanInfo.getAwardGoodsInfo().getGoodsPrice_VirtualPrice()));
        ...
        tvYuPrice.setText(String.valueOf(awardBeanInfo.getAwardGoodsInfo().getBond()));
        tvPrice.setText("中奖后再付：" + String.valueOf(awardBeanInfo.getAwardGoodsInfo().getGoodsPrice_Price()-awardBeanInfo.getAwardGoodsInfo().getBond()));
    ...
    private void initBanner(List<String> awardGoodsBanner) {
        //设置banner样式
